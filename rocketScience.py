...
def main():
	...
	print("Best fin geometry found:")
	print(f"  Root chord: {best_geom.root_chord:.4f} m")
	print(f"  Tip chord : {best_geom.tip_chord:.4f} m")
	print(f"  Span      : {best_geom.span:.4f} m")
	print(f"  Sweep     : {best_geom.sweep_deg:.2f} deg")
	print(f"Nondimensional stability margin: {best_margin:.4f}"
		  "  ( (CP - CG)/diameter )")
